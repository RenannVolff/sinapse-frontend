      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 bg-white p-6 rounded-2xl border border-gray-100 shadow-sm">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-gray-500 text-sm mt-1">Planos Educacionais Individualizados registrados para este aprendente.</p>
          </div>
        </div>
      ...
      <div className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
        {loading ? (
          <div className="flex flex-col items-center justify-center p-16">
            ...
            <p className="text-gray-500 font-medium">Buscando PEIs...</p>
          </div>
        ) : peis.length === 0 ? (
          <div className="text-center p-16">
            ...
            <h3 className="text-xl font-bold text-gray-900">Nenhum PEI cadastrado</h3>
            <p className="text-gray-500 mt-2">Crie o primeiro Plano Educacional Individualizado deste aprendente.</p>
          </div>
        ) : (
          <div className="divide-y divide-gray-50">
            {peis.map((pei) => (
              <div
                ...
                className="p-5 flex items-center justify-between gap-4 hover:bg-blue-50/30 transition-colors cursor-pointer group"
              >
                <div className="flex items-start gap-3 min-w-0">
                  <div className="p-2 bg-blue-50 text-primary rounded-lg mt-0.5 flex-shrink-0">
                ...
                <button className="flex items-center gap-1 text-sm font-bold text-blue-600 flex-shrink-0">
